...
import { parseMultipleTimetableFiles } from '../services/candidateParser';
...
export const TimetableManager: React.FC = () => {
  ...
  const handleDownloadTimetableTemplate = () => {
    ...
    const sampleRows = [
      '6127/01,Art (Revised) Paper 1,2026-10-15,08:00,120,WRITTEN,No,Yes',
      '1128/01,English Language Paper 1,2026-10-19,08:00,110,WRITTEN,No,Yes',
      '1128/03,English Language Paper 3 (LC),2026-10-20,14:00,45,LISTENING COMPREHENSION,No,No',
      '7155/01,Computing Paper 1,2026-10-22,08:00,120,WRITTEN,Yes,Yes',
      '6091/03,Physics Practical Paper 3,2026-10-27,08:00,110,PRACTICAL,No,No'
    ];
...
const PaperModal: React.FC<PaperModalProps> = ({ paper, onClose, onSave }) => {
  ...
  const [allowCombine, setAllowCombine] = useState(paper?.allowCombine ?? true);
