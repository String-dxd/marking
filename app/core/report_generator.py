...
class NumberedCanvas(canvas.Canvas):
    ...
    def draw_page_decorations(self, page_count: int):
        ...
        self.drawString(36, 20, "Tallus • Individual Student Feedback Report • Confidential")
...
def generate_pdf_report(submission: Dict[str, Any], output_path: Optional[str] = None) -> str:
    ...
    story.append(Spacer(1, 10))
    story.append(Paragraph("<font size='7.5' color='#94A3B8'>Report generated by Tallus • Verified by Teacher • Privacy Assured (Local AI)</font>", ParagraphStyle('FooterTag', alignment=TA_CENTER)))
